...
from quant import QuantModule, Union
...
class GetLayerInpOut:
    ...
    def __call__(self, model_input):
        self.model.eval()
        set_quant_state(self.model, False, False)
        ...
        with torch.no_grad():
            ...
            if self.asym:
                ...
                set_quant_state(self.model, True, self.act_quant)
...
def quantize_model_till(model: QuantModule, layer, act_quant: bool = False):
    """
